...
3. Once you clicked it configuration form will be opened in case if template saved. If template contains unsaved data firstly you need to save template.
...
6. Than you can save configuration by clicking the "Save" button
...
Once you've added configuration you can delete it. To do that just open configuration as for creation and click the "Delete" button. Configuration will be deleted and no more available for particular version of template.
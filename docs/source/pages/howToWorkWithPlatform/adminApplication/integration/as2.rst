...
=====================
To connect AS2 server customer should use autogenerated data and fill in required data of recipient side from integration page **/admin/integrations/list**

#. Self URL - url of WhiteDoc AS2 server
#. Self certificate - certificate of AS2 server
#. Self ID - self ID of connection to AS2 server
#. Recipient URL - connection URL to AS2 server (files will be send here)
...
#. Encryption algorithm - optional param of encryption, by default 3des chosen
#. Signing algorithm - optional param of signing algorithm, by default md5 chosen

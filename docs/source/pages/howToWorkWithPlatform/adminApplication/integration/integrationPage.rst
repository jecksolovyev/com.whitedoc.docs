...
Data in connection details (3) block automatically generated for connection protocols FTPS and SFTP except password, it will be generated after save button click, credential from this block should be use for connect to ftp server. Customer can copy each this parameters by click on copy button.
...
By default conversion rule list is empty. To create new rule just click on "Add new rule" button, after that customer will be redirected to conversion rule creation form.
